...
_CHECKPOINT = '../attention_ocr_2017_08_09/model.ckpt-399731'
...
class DemoInferenceTest(tf.test.TestCase):
  ...
  #                                    image_path_pattern)
  #
  #   predictions = [decode_code(code) for code in predictions]
  #   print("--------------------------")
  ...
  def test_correct_results_on_test_data2(self):
    image_path_dir = 'testdata2'
    predictions = demo_inference.run(_CHECKPOINT, self._batch_size,
                                     'my_data',
                                     image_path_dir, use_dir=True)
